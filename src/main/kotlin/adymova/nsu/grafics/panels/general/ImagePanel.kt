...
class ImagePanel(private val imageContext: ImageContext) : JPanel(), ChangeHsvListener, ImageUpdateListener {
    ...
    init {
        ...
        imageContext.subscribeImageUpdateListener(this)
    }
